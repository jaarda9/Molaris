...
- Antibiotiques — guide OMS AWaRe 2022 (infections bucco-dentaires) : pas d'antibiotique pour la douleur, la pulpite, ni avant un acte courant « pour dégonfler » ; le traitement est le geste (drainage, pulpectomie, extraction). Antibiotique seulement en complément, pour une infection qui s'étend avec signes généraux (tuméfaction faciale, trismus, fièvre ≥ 38 °C), une immunodépression sévère ou un diabète non équilibré. Premier choix (groupe « Access ») : amoxicilline 500 mg toutes les 8 h ou phénoxyméthylpénicilline 500 mg toutes les 6 h, 3 jours si la cause est traitée, sinon 5 jours ; enfant : amoxicilline 80–90 mg/kg/jour. Évite les antibiotiques du groupe « Watch » (azithromycine, clarithromycine) sauf raison précise. Une infection qui s'étend vers le plancher buccal ou l'orbite est une urgence hospitalière.
