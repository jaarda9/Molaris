...
window.MOLARIS_TRANSLATIONS = {
  en: {
    ...
    "nav.perio": "Perio Chart",
    "nav.labcases": "Lab Cases",

    // Advisor Chat
    "chat.headerTitle": "Senior Dental Advisor Direct Line",
    "chat.headerSubtitle": "Attending Specialist • Evidence-based ADA & ESE Guidance",
    "chat.clearFeed": "Clear Feed",
    "chat.welcomeSender": "M.O.L.A.R.I.S SENIOR ADVISOR",
    "chat.welcomeGreeting": "Good day, Doctor. I am standing by chairside. What procedure or diagnostic dilemma are we facing today?",
    "chat.welcomeLi1": "Struggling with a hot lower molar with irreversible pulpitis?",
    "chat.welcomeLi2": "Need immediate maximum carpule calculation for a cardiac patient?",
    "chat.welcomeLi3": "Wondering whether to perform an indirect pulp cap with MTA or initiate root canal therapy?",
    "chat.welcomeLi4": "Dealing with a separated file, deep subgingival margin, or dry socket?",
    "chat.welcomeHint": "Ask directly, speak hands-free via the microphone, or click any prompt below.",
    "chat.contextualFocus": "Contextual Focus:",
    "chat.removeFocus": "✕ Remove",
    "chat.inputPlaceholder": "Ask senior advice (e.g. 'How to anesthetize hot #30?' or 'DME vs crown lengthening')...",
    "chat.sendBtn": "Ask Senior",
    "chat.micStatus": "● Hands-free operatory mic listening... Speak your clinical query",
    "chat.micTooltip": "Hands-free Operatory Voice Dictation",
    "chat.quickStarters": "Chairside Quick Starters",
    "chat.oneClick": "1-CLICK",
    "chat.starter1Title": "Hot Tooth:",
    "chat.starter1Desc": "Patient still feels cold on #30 after IANB. Next step?",
    "chat.starter2Title": "Pulp Exposure:",
    "chat.starter2Desc": "Pinpoint bleeding during caries removal. MTA direct cap or RCT?",
    "chat.starter3Title": "Subgingival Box:",
    "chat.starter3Desc": "Deep margin elevation vs surgical crown lengthening?",
    "chat.starter4Title": "Separated File:",
    "chat.starter4Desc": "NiTi #20 .04 broke in apical third of MB canal. Protocol?",
    "chat.starter5Title": "Cardiac Anesthesia:",
    "chat.starter5Desc": "Maximum Articaine vs Mepivacaine carpules?",
    ...
    "odonto.consultBtn": "Ask Senior Advisor About This Tooth",
    ...
    "vision.badge": "Gemini Multimodal",
    "vision.subtitle": "Upload periapical x-rays, bitewings, panoramic radiographs, or intraoral camera photographs for senior second-opinion diagnostic review.",
    "vision.dropPrompt": "Click or drag & drop dental radiograph",
    "vision.dropSub": "JPEG, PNG, DICOM-exported formats up to 20MB",
    "vision.samplesTitle": "Or test with clinical sample cases:",
    "vision.sampleA": "Case A: Periapical #30",
    "vision.sampleADesc": "PA radiolucency & deep caries",
    "vision.sampleB": "Case B: Bitewing #14-#15",
    "vision.sampleBDesc": "Interproximal lesion & bone loss",
    "vision.questionLabel": "Specific Diagnostic Focus:",
    "vision.questionPlaceholder": "Ask a specific clinical question (e.g. 'Evaluate bone loss around #19' or 'Is there furcation involvement on #30?')...",
    "vision.analyzeBtn": "Analyze with Senior Advisor",
    "vision.resultTitle": "Senior Specialist Radiographic Findings",
    "vision.resultEmpty": "Upload a periapical x-ray, bitewing, or clinical photo to trigger senior multimodal analysis.",

    // Clinical Playbooks
    "playbooks.title": "Senior Chairside Procedural Protocols & Complications Playbooks",
    ...
    // SOAP Note Generator
    "soap.title": "SOAP Progress Note & CDT Generator",
    "soap.subtitle": "Generate a legally airtight clinical progress note formatted in Subjective, Objective, Assessment, Plan with official CDT codes.",
    "soap.procedureLabel": "Procedure Type:",
    "soap.procedurePlaceholder": "e.g. Root Canal Therapy, Composite Restoration, Simple Extraction...",
    "soap.toothLabel": "Tooth Involved:",
    "soap.anesthesiaLabel": "Local Anesthesia Administered:",
    "soap.anesthesiaPlaceholder": "e.g. 1.5 carpules 4% Articaine 1:100k IANB + 0.5 carpule buccal infiltration",
    "soap.materialsLabel": "Materials & Isolation:",
    "soap.materialsPlaceholder": "e.g. Rubber dam, Kerr OptiBond Universal, Filtek One bulk fill composite...",
    "soap.detailsLabel": "Clinical Outcome & Post-Op Instructions:",
    "soap.detailsPlaceholder": "Procedure completed uneventfully. Patient tolerated well. Advised soft diet until numbness subsides. Ibuprofen 600mg advised prn.",
    "soap.generateBtn": "Generate Medicolegal SOAP Note",
    "soap.outputTitle": "Generated Progress Note",
    "soap.copyBtn": "Copy Note",
    "soap.saveBtn": "Save to Patient Record",

    // Patient Manager
    "patients.title": "Patient Records & Operatory Database",
    "patients.badge": "Local File: data/patients-db.json",
    "patients.subtitle": "Select a patient to bind the 32-tooth odontogram, local anesthesia calculator, and clinical notes to their chart.",
    "patients.searchPlaceholder": "Search patients by name, chart ID, ASA, or medical condition...",
    "patients.addNew": "+ Add New Patient",
    "patients.exportDb": "Export DB",
    "patients.importDb": "Import DB",
    ...
    // Periodontal Chart
    "perio.title": "Full-Mouth Perio Chart",
  ...
  fr: {
    ...
    "timer.cure": "20s",
    "timer.stop": "Arrêt",
    "timer.etchTitle": "Mordançage Acide 15s",
    "timer.cureTitle": "Polymérisation 20s",
    "header.voiceTooltip": "Activer/Désactiver la Synthèse Vocale",
    "header.themeTooltip": "Basculer Mode Clair / Sombre",
    ...
    "nav.perio": "Charte Parodontale",
    "nav.labcases": "Cas de Laboratoire",

    // Advisor Chat
    "chat.headerTitle": "Ligne Directe Conseiller Dentaire Senior",
    "chat.headerSubtitle": "Spécialiste Référent • Recommandations Basées sur les Preuves (ADA, ESE & HAS)",
    "chat.clearFeed": "Effacer le Fil",
    "chat.welcomeSender": "M.O.L.A.R.I.S CONSEILLER SENIOR",
    "chat.welcomeGreeting": "Bonjour Docteur. Je suis à vos côtés au fauteuil. Quelle intervention ou quel dilemme diagnostique rencontrons-nous aujourd'hui ?",
    "chat.welcomeLi1": "Difficulté d'anesthésie sur une molaire mandibulaire en pulpite aiguë (dent chaude) ?",
    "chat.welcomeLi2": "Besoin immédiat du calcul de dose maximale en carpules pour un patient cardiaque ?",
    "chat.welcomeLi3": "Hésitation entre coiffage pulpaire direct/indirect au MTA/Biodentine et pulpectomie ?",
    "chat.welcomeLi4": "Gestion d'un instrument fracturé, d'une marge sous-gingivale profonde ou d'une alvéolite sèche ?",
    "chat.welcomeHint": "Posez directement votre question, dictez mains-libres au micro, ou cliquez sur un déclencheur rapide ci-dessous.",
    "chat.contextualFocus": "Focus Clinique :",
    "chat.removeFocus": "✕ Retirer",
    "chat.inputPlaceholder": "Demandez conseil au senior (ex: 'Comment anesthésier 46 chaude ?' ou 'DME vs élongation coronaire')...",
    "chat.sendBtn": "Consulter Senior",
    "chat.micStatus": "● Micro opératoire mains-libres actif... Énoncez votre question clinique",
    "chat.micTooltip": "Dictée Vocale Opératoire Mains-Libres",
    "chat.quickStarters": "Déclencheurs Rapides au Fauteuil",
    "chat.oneClick": "1-CLIC",
    "chat.starter1Title": "Dent Chaude :",
    "chat.starter1Desc": "Douleur au froid persistante sur 46 après Spix. Quelle conduite ?",
    "chat.starter2Title": "Effraction Pulpaire :",
    "chat.starter2Desc": "Saignement punctiforme au curetage carieux. Coiffage MTA ou Endo ?",
    "chat.starter3Title": "Limite Sous-gingivale :",
    "chat.starter3Desc": "Remontée de marge cervicale (DME) ou élongation coronaire ?",
    "chat.starter4Title": "Instrument Fracturé :",
    "chat.starter4Desc": "Lime NiTi #20 .04 séparée au tiers apical canal MV. Protocole ?",
    "chat.starter5Title": "Anesthésie Cardiaque :",
    "chat.starter5Desc": "Dose maximale Articaïne vs Mépi vacaine chez cardiaque ?",
    ...
    "chat.sidebarNotation": "Système de Notation :",
    "chat.triageTitle": "Triage d'Urgence au Fauteuil",
    ...
    "odonto.fdiSystem": "FDI (11-48)",
    "odonto.resetBtn": "Réinitialiser Schéma",
    "odonto.legendTitle": "Légende des Statuts :",
    ...
    "odonto.maxillarySub": "Quadrant 1 (1-8 / 18-11) • Quadrant 2 (9-16 / 21-28)",
    "odonto.occlusalPlane": "Plan d'Occlusion",
    "odonto.mandibularArch": "Arcade Inférieure • Mandibulaire (Droite → Gauche)",
    "odonto.mandibularSub": "Quadrant 4 (32-25 / 48-41) • Quadrant 3 (24-17 / 31-38)",
    "odonto.drawerTitle": "Examen Dentaire & Constatations",
    "odonto.consultBtn": "Consulter le Conseiller Senior sur cette Dent",
    "odonto.statusLabel": "État / Pathologie de la Dent :",
    ...
    "odonto.statusRct": "Traitement Endo (Dévitalisée)",
    "odonto.statusImplant": "Implant Posé",
    "odonto.statusMissing": "Absente / Extraite",
    "odonto.surfacesLabel": "Surfaces Concernées :",
    "odonto.surfaceOcclusal": "Occlusale / Incisif",
    ...
    "odonto.notesLabel": "Observations Cliniques & Plan de Traitement :",
    "odonto.notesPlaceholder": "ex: Carie disto-occlusale profonde, test froid négatif, percussion sensible...",
    "odonto.saveBtn": "Enregistrer Constatations",
    ...
    "la.resetCarpulesBtn": "Réinitialiser Compteur",
    "la.calcLimitTitle": "Limite Sécuritaire Calculée :",
    "la.calcLimitFactor": "Facteur : Mg/Kg de Poids Corporel",
    "la.resultMaxCarpules": "Carpules Max Sans Risque",
    "la.resultMaxMg": "Dose Anesthésique Max (mg)",
    ...
    "vision.badge": "Gemini Multimodal",
    "vision.subtitle": "Importez radiographies rétro-alvéolaires, bitewings, panoramiques ou photos intra-orales pour un second avis diagnostique expert.",
    "vision.dropPrompt": "Cliquer ou glisser-déposer une radiographie dentaire",
    "vision.dropSub": "Formats JPEG, PNG, exports DICOM jusqu'à 20 Mo",
    "vision.samplesTitle": "Ou tester avec des cas cliniques d'exemple :",
    "vision.sampleA": "Cas A : Rétro-alvéolaire 46 (#30)",
    "vision.sampleADesc": "Radioclarté périapicale & carie profonde",
    "vision.sampleB": "Cas B : Bitewing 26-27 (#14-#15)",
    "vision.sampleBDesc": "Lésion interproximale & alvéolyse",
    "vision.questionLabel": "Question Diagnostique Précise :",
    "vision.questionPlaceholder": "Posez une question clinique précise (ex: 'Évaluer la résorption osseuse autour de 36' ou 'Y a-t-il une atteinte de furcation ?')...",
    "vision.analyzeBtn": "Analyser avec le Conseiller Senior",
    "vision.resultTitle": "Rapport Radiologique du Spécialiste Senior",
    "vision.resultEmpty": "Importez une radio rétro-alvéolaire, un bitewing ou une photo clinique pour déclencher l'analyse senior.",

    // Clinical Playbooks
    "playbooks.title": "Protocoles Cliniques au Fauteuil & Gestion des Complications",
    "playbooks.subtitle": "Arbres décisionnels et fiches réflexes conçus pour consultation immédiate sous pression opératoire.",
    "playbooks.filterAll": "Tous les Protocoles",
    ...
    "playbooks.askAdvisor": "Consulter Conseiller",

    // SOAP Note Generator
    "soap.title": "Générateur de Compte-Rendu SOAP & Cotations",
    "soap.subtitle": "Générez une note d'évolution clinique formelle au format Subjectif, Objectif, Analyse, Plan avec cotations officielles.",
    "soap.procedureLabel": "Nature de l'Acte Réalisé :",
    "soap.procedurePlaceholder": "ex: Traitement endodontique, Obturation composite stratification, Extraction chirurgicale...",
    "soap.toothLabel": "Dent Concernée :",
    "soap.anesthesiaLabel": "Anesthésie Locale Administrée :",
    "soap.anesthesiaPlaceholder": "ex: 1,5 carpule Articaïne 4% 1:100 000 à l'épine de Spix + 0,5 carpule en vestibulaire",
    "soap.materialsLabel": "Matériaux & Champ Opératoire :",
    "soap.materialsPlaceholder": "ex: Pose de digue unitaire, adhésif OptiBond Universal, composite de restauration Filtek...",
    "soap.detailsLabel": "Déroulement Clinique & Suites Post-Opératoires :",
    "soap.detailsPlaceholder": "Acte réalisé avec succès sans complication. Patient a bien toléré. Consignes de mastication molle. Antalgiques prescrits.",
    "soap.generateBtn": "Générer la Note SOAP Médico-Légale",
    "soap.outputTitle": "Compte-Rendu d'Évolution Clinique Généré",
    "soap.copyBtn": "Copier la Note",
    "soap.saveBtn": "Enregistrer dans le Dossier Patient",

    // Patient Manager
    "patients.title": "Dossiers Patients & Base de Données Opératoire",
    "patients.badge": "Fichier Local : data/patients-db.json",
    "patients.subtitle": "Sélectionnez un patient pour lier l'odontogramme 32 dents, le calculateur d'anesthésie et les notes cliniques à son dossier.",
    "patients.searchPlaceholder": "Rechercher par nom, IPP, statut ASA ou antécédent médical...",
    "patients.addNew": "+ Nouveau Dossier Patient",
    "patients.exportDb": "Exporter BDD",
    "patients.importDb": "Importer BDD",
    "patients.selectAndTreat": "Sélectionner & Soigner",
    "patients.activePatientBtn": "✓ Dossier Actif au Fauteuil",
    "patients.editChart": "Modifier le Dossier",
    "patients.deleteRecord": "Supprimer le Dossier",
    "patients.teethCharted": "Dents Chartées",
    "patients.carpulesLa": "Carpules AL",
    "patients.soapNotes": "Notes SOAP",
    "patients.modalAddTitle": "Ajouter un Nouveau Dossier Patient",
    "patients.modalEditTitle": "Modifier le Dossier Patient",
    "patients.fullName": "Nom Complet du Patient *",
    "patients.chartId": "N° de Dossier (IPP) *",
    "patients.age": "Âge",
    ...
    "prefs.degree": "Titre & Spécialité :",
    "prefs.school": "Faculté Dentaire / Formation :",
    "prefs.bondingSystem": "Système Adhésif Préféré :",
    "prefs.compositeSystem": "Composite Restaurateur Préféré :",
    ...
    "prefs.saveBtn": "Enregistrer le Profil Clinique",
    ...
    "safety.title": "Alertes de Sécurité Permanentes",
    ...
    // Charte Parodontale
    "perio.title": "Charte Parodontale Complète",
    ...
    "perio.history": "Historique des Relevés",
    ...
    "perio.saveEntry": "Mettre à Jour la Dent (En Mémoire)",
    ...
    // Cas de Laboratoire
    "labcases.title": "Cas de Laboratoire",
    ...
    "labcases.addBtn": "+ Ajouter un Cas",
    "labcases.modalTitle": "Ajouter un Cas de Laboratoire",
    "labcases.tooth": "Dent n°",
    "labcases.caseType": "Type de Cas *",
    ...
    "labcases.labName": "Nom du Laboratoire",
    "labcases.dueDate": "Date d'Échéance",
    "labcases.notes": "Notes",
    "labcases.status": "Statut",
    "labcases.save": "Enregistrer le Cas",
...
window.applyMolarisLanguage = function(lang) {
  ...
  // Chat Welcome Message (if initial)
  const initialWelcome = document.querySelector('#chat-messages .space-y-3');
  if (initialWelcome) {
    const welcomeHeader = initialWelcome.closest('.bg-white\\/80, .bg-white')?.querySelector('.font-bold.text-xs');
    if (welcomeHeader) welcomeHeader.textContent = t('chat.welcomeSender');
    const welcomeP = initialWelcome.querySelector('p');
    if (welcomeP) welcomeP.textContent = t('chat.welcomeGreeting');
    const lis = initialWelcome.querySelectorAll('li');
    if (lis.length >= 4) {
      lis[0].innerHTML = `<span class="text-teal-600 dark:text-teal-400 font-bold">•</span><span>${t('chat.welcomeLi1')}</span>`;
      lis[1].innerHTML = `<span class="text-teal-600 dark:text-teal-400 font-bold">•</span><span>${t('chat.welcomeLi2')}</span>`;
      lis[2].innerHTML = `<span class="text-teal-600 dark:text-teal-400 font-bold">•</span><span>${t('chat.welcomeLi3')}</span>`;
      lis[3].innerHTML = `<span class="text-teal-600 dark:text-teal-400 font-bold">•</span><span>${t('chat.welcomeLi4')}</span>`;
    }
    const welcomeHint = initialWelcome.querySelector('p.italic');
    if (welcomeHint) welcomeHint.textContent = t('chat.welcomeHint');
  }

  // Quick prompt buttons
  const quickTitle = document.querySelector('.lg\\:col-span-4 h3, #view-advisor .lg\\:col-span-4 h3');
  if (quickTitle) quickTitle.textContent = t('chat.quickStarters');

  const quickBtns = document.querySelectorAll('.quick-prompt-btn');
  if (quickBtns.length >= 6) {
    quickBtns[0].querySelector('span:last-child').innerHTML = `<strong>${t('chat.starter1Title')}</strong> ${t('chat.starter1Desc')}`;
    quickBtns[1].querySelector('span:last-child').innerHTML = `<strong>${t('chat.starter2Title')}</strong> ${t('chat.starter2Desc')}`;
    quickBtns[2].querySelector('span:last-child').innerHTML = `<strong>${t('chat.starter3Title')}</strong> ${t('chat.starter3Desc')}`;
    quickBtns[3].querySelector('span:last-child').innerHTML = `<strong>${t('chat.starter4Title')}</strong> ${t('chat.starter4Desc')}`;
    quickBtns[4].querySelector('span:last-child').innerHTML = `<strong>${t('chat.starter5Title')}</strong> ${t('chat.starter5Desc')}`;
    quickBtns[5].querySelector('span:last-child').innerHTML = `<strong>${t('chat.starter6Title')}</strong> ${t('chat.starter6Desc')}`;
  }
  ...
  if (dropP) dropP.textContent = t('vision.dropPrompt');
  const dropSub = document.querySelector('#drop-zone span.text-xs');
  if (dropSub) dropSub.textContent = t('vision.dropSub');
  const runVisionSpan = document.querySelector('#run-vision-btn span');
