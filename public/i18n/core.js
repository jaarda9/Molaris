...
window.MOLARIS_TRANSLATIONS = {
  en: {
    ...
    "vision.subtitle": "Upload a periapical, bitewing or panoramic radiograph, or an intraoral photo, for a second reading (decision support).",
    ...
    "soap.subtitle": "Draft a progress note (Subjective, Objective, Assessment, Plan) for the active patient. The AI draft is saved to the chart: review and complete it.",
  ...
  fr: {
    ...
    "vision.badge": "Gemini Multimodal",
    "vision.subtitle": "Importez une radiographie rétro-alvéolaire, bitewing ou panoramique, ou une photo intra-orale, pour une seconde lecture (aide à la décision).",
    ...
    "vision.questionLabel": "Question diagnostique précise (facultatif) :",
    ...
    "vision.resultTitle": "Lecture radiographique (à confirmer)",
    ...
    "vision.analyzing": "Analyse de l'image par Gemini Vision...",
    ...
    "soap.subtitle": "Projet de compte-rendu (Subjectif, Objectif, Analyse, Plan) pour le patient actif. Le brouillon IA est enregistré au dossier : relisez-le et complétez-le.",
