...
Molaris.i18n.register({
  en: {
    ...
    'la.form.logBtn': 'Log in the chart',
    'la.cancelEntry': 'Cancel',
    'la.entryCancelled': 'cancelled',
    'la.cancelEntryTitle': 'Cancel an anesthesia entry',
    'la.cancelEntryConfirm': 'Cancel this entry',
    'la.cancelEntryExplain': 'The entry stays in the chart, struck through, and no longer counts toward today’s dose.',
    'la.cancelEntryReason': 'Reason (required), e.g. wrong dictation, wrong patient',
    'la.form.logged': '{n} carpule(s) of {drug} logged in the chart',
  ...
  fr: {
    ...
    'la.form.logBtn': 'Enregistrer au dossier',
    'la.cancelEntry': 'Annuler',
    'la.entryCancelled': 'annulée',
    'la.cancelEntryTitle': 'Annuler une saisie d’anesthésie',
    'la.cancelEntryConfirm': 'Annuler cette saisie',
    'la.cancelEntryExplain': 'La saisie reste dans le dossier, barrée, et n’est plus comptée dans la dose du jour.',
    'la.cancelEntryReason': 'Motif (obligatoire), ex. dictée erronée, mauvais patient',
    'la.form.logged': '{n} carpule(s) de {drug} enregistrée(s) au dossier',
